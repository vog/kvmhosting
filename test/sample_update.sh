...
#!/bin/sh
exec xsltproc --param action "'network'" /etc/kvmhosting/kvmhosting.xsl /etc/kvmhosting/config.xml
EOF
...
#!/bin/sh
exec xsltproc --param action "'http'" /etc/kvmhosting/kvmhosting.xsl /etc/kvmhosting/config.xml
EOF
...
#!/bin/sh
exec xsltproc --param action "'guest'" --param name "'private'" /etc/kvmhosting/kvmhosting.xsl /etc/kvmhosting/config.xml
EOF
...
#!/bin/sh
exec xsltproc --param action "'guest'" --param name "'tcponly'" /etc/kvmhosting/kvmhosting.xsl /etc/kvmhosting/config.xml
EOF
...
#!/bin/sh
exec xsltproc --param action "'guest'" --param name "'httponly'" /etc/kvmhosting/kvmhosting.xsl /etc/kvmhosting/config.xml
EOF
...
#!/bin/sh
exec xsltproc --param action "'guest'" --param name "'complex'" /etc/kvmhosting/kvmhosting.xsl /etc/kvmhosting/config.xml
EOF
